(function($){
	...
	$.fn.tooltip = function(instanceSettings){
		...
		$.fn.tooltip.defaultsSettings = {
			...
			followMouse:1,
			height:'auto',
			hoverIntent:{sensitivity:1,interval:1,timeout:0},
			loader:0,
			loaderHeight:0,
			loaderImagePath:'',
			loaderWidth:0,
		...
		return this.each(function(index){
			...
			function on(e){	
				...
				$('body').append('<div id="'+s.tooltipID+'" style="padding:'+s.tooltipPadding+'px;display:none;height:'+s.height+';width:'+s.width+';background-color:'+s.tooltipBGColor+';border:'+s.borderSize+'px solid '+s.borderColor+'; position:absolute;z-index:100000000000;"><div id="tooltipContent" style="display:none;"></div></div>');
